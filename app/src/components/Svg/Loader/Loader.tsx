...
export default function Loader({ color, ...props }: LoaderProps) {
  return (
    <svg version="1.1" id="L6" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
      viewBox="0 0 100 100" enableBackground="new 0 0 100 100" xmlSpace="preserve" {...props}>
      <rect fill="none" stroke={color} strokeWidth="4" x="25" y="25" width="50" height="50">
        <animateTransform
