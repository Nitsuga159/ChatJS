import { ReactNode, createContext, useCallback, useEffect, useLayoutEffect, useRef, useState } from "react";
...
const ShowOnAllScreenContext =
  createContext<ShowOnAllScreenType>(() => console.warn("ShowOnAllScreen: using default function"));
...
function ShowOnAllScreenProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <ShowOnAllScreenContext.Provider value={showOnAllScreen}>
      {children}
